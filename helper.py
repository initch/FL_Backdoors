...
class Helper:
    ...
    def __init__(self, params):
        ...
        self.make_folders()
        self.make_task()
        if self.params.synthesizer.lower() == 'dba':
            self.synthesizer = self.make_synthesizer((0, self.params.fl_number_of_adversaries))
        else:
            self.synthesizer = self.make_synthesizer()
    ...
    def make_synthesizer(self, mal=None):
        ...
        if self.params.synthesizer.lower() == 'dba':
            synthesizer = task_class(self.task, mal)
        else:
            synthesizer = task_class(self.task)
        return synthesizer
