...
class TinyImageNetTask(Task):
	...
	def load_data(self):
		return self.load_tiny_imagenet_data()
	
	def load_tiny_imagenet_data(self):

		self.train_dataset = TinyImageNet("/home/bei_chen/data/tiny-imagenet-200",
						train=True,
		...
		self.test_dataset = TinyImageNet("/home/bei_chen/data/tiny-imagenet-200",
						train=False,
						transform=transforms.Compose([
							# transforms.RandomCrop(64, padding=4),
							transforms.RandomHorizontalFlip(),
