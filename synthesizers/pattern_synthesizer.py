...
class PatternSynthesizer(Synthesizer):
	...
	def synthesize_inputs(self, batch, attack_portion=None):
		...
		# torchvision.utils.save_image(batch.inputs[0], f'clean_img.png')
		batch.inputs[:attack_portion] = (1 - mask) * \
										batch.inputs[:attack_portion] + \
										mask * pattern
		torchvision.utils.save_image(batch.inputs[0], f'poisoned_img_{self.params.trigger}.png')
